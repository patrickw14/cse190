...
cursor.execute("CREATE OR REPLACE FUNCTION add_to_post_fn() RETURNS trigger AS $addtopost$ BEGIN INSERT INTO mat_view_post (posterID, num_of_post) SELECT NEW.id, 0; RETURN NEW; END $addtopost$ LANGUAGE 'plpgsql';")
