...
cursor.execute("SELECT num_of_read, num_of_post FROM (mat_view_case1) natural join (SELECT mb.nation, m.num_of_post FROM mat_view_post m, member mb WHERE m.posterid = mb.id)")
